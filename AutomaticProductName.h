...
#define PRODUCT_NAME        L"MidiGlass - Version 4.0.04.014\r\n(Build 217) - (x64 Unicode) (MSVC)\0"
#else
#define ORIGINAL_FILENAME   "MidiGlass (x64 MBCS) (MSVC)\0"
#define PRODUCT_NAME        "MidiGlass - Version 4.0.04.014\r\n(Build 217) - (x64 MBCS) (MSVC)\0"
#endif
#elif _WIN32
#ifdef UNICODE
#define ORIGINAL_FILENAME   L"MidiGlass (x86 Unicode) (MSVC)\0"
#define PRODUCT_NAME        L"MidiGlass - Version 4.0.04.014\r\n(Build 217) - (x86 Unicode) (MSVC)\0"
#else
#define ORIGINAL_FILENAME   "MidiGlass (x86 MBCS) (MSVC)\0"
#define PRODUCT_NAME        "MidiGlass - Version 4.0.04.014\r\n(Build 217) - (x86 MBCS) (MSVC)\0"
#endif
#else
